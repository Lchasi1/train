...
public class PassengerService {
    ...
    @Autowired
    private PassengerMapperpassengerMapper;

    /**
     * 会员端保存信息，以及注册的更改信息
     *
     * @parampassengerSaveReq
     */
    public void save(PassengerSaveReqpassengerSaveReq) {
        DateTime now = DateTime.now();
        Passengerpassenger = BeanUtil.copyProperties(passengerSaveReq, Passenger.class);
    ...
    public PageResp<PassengerQueryResp> queryList(PassengerQueryReq req) {
        PassengerExamplepassengerExample = new PassengerExample();
